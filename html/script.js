...
// Six staff slots. Put staff images in html/staff/ and use paths like "staff/jane.png".
const staffMembers = [
  {
    name: "Bradshaw",
  ...
  },
  {
    name: "Staff 2",
    role: "Co-Owner",
    description: "Operations, support, and server management.",
    image: "staff/placeholder.png"
  },
  {
    name: "Staff 3",
    role: "Head Admin",
    description: "Helps keep roleplay fair and organized.",
    image: "staff/placeholder.png"
  },
  {
    name: "Staff 4",
    role: "Admin",
    description: "Handles tickets, reports, and player support.",
    image: "staff/placeholder.png"
  },
  {
    name: "Staff 5",
    role: "Moderator",
    description: "Assists players and monitors the city.",
    image: "staff/placeholder.png"
  },
  {
    name: "Staff 6",
    role: "Support",
    description: "New-player help and community questions.",
    image: "staff/placeholder.png"
  }
];
...
// Six wanted slots. Put mugshots in html/wanted/ and use paths like "wanted/suspect.png".
...
const MOST_WANTED_SUSPECTS = [
  ...
  {
    name: "Name 5",
    reason: "Burglary / evasion",
    image: "wanted/placeholder.png",
    photoPosition: "center center"
  },
  {
    name: "Name 6",
    reason: "Homicide investigation",
    image: "wanted/placeholder.png",
    photoPosition: "center center"
  }
];
...
// Six gallery photo slots. Put images in html/gallery/ and use paths like "gallery/event1.png".
...
function setupStaffPanel() {
  ...
  if (!rows.length) {
    ...
    rows.forEach((member) => {
      ...
      img.src = member.image || "staff/placeholder.png";
      ...
      img.onerror = function () {
        this.onerror = null;
        this.src = "staff/placeholder.png";
      };
...
function setWantedSlot(index, suspect) {
  ...
  photo.src = safeSuspect.image || "wanted/placeholder.png";
  ...
  photo.onerror = function () {
    this.onerror = null;
    this.src = "wanted/placeholder.png";
  };
...
function setupGalleryPanel() {
  ...
  if (!photos.length) {
    ...
    photos.forEach((photo, index) => {
      ...
      const img = document.createElement("img");
      img.src = photo.image || "gallery/placeholder.png";
